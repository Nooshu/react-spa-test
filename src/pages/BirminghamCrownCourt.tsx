      ...
      <div className="govuk-grid-row court-tribunal-details">
        <div className="govuk-grid-column-two-thirds">
          ...
          <p className="govuk-body-m address">
            Queen Elizabeth II Law Courts<br />
            1 Newton Street<br />
            Birmingham<br />
            B4 7NA
          </p>
          ...
          <p className="govuk-body-m" id="direction-map">
            <a className="govuk-link" rel="noreferrer noopener" target="_blank" href="https://maps.google.com/maps?q=52.4819,-1.8998">
          ...
          <div id="emails">
              ...
              <dl className="govuk-summary-list">
                <div className="govuk-summary-list__row">
                  ...
                  <dd className="govuk-summary-list__value">
                    <a className="govuk-link" href="mailto:enquiries.birmingham.crowncourt@justice.gov.uk">
          ...
          <div id="contacts">
              ...
              <dl className="govuk-summary-list">
                <div className="govuk-summary-list__row">
                  ...
                  <dd className="govuk-summary-list__value">
                    <a className="govuk-link" href="tel:0121 681 3300">0121 681 3300</a>
                  </dd>
                </div>
                <div className="govuk-summary-list__row">
                  <dd className="govuk-summary-list__key">
          ...
          <div id="building-facilities">
              ...
              <p className="govuk-body-m">
                If you have a disability and need help coming to a hearing, please contact 0121 681 3300.
              </p>
              ...
              <dl className="govuk-summary-list">
                ...
                <div className="govuk-summary-list__row">
                  ...
                  <dd className="govuk-summary-list__value">
                    <p className="govuk-body-m">
                      Fifteen interview rooms are available at this court.
                    </p>
                  </dd>
                </div>
                <div className="govuk-summary-list__row">
        ...
        <div className="govuk-grid-column-one-third side-content" style={{ marginTop: '0' }}>
          <div className="govuk-grid-row">
            <img src="/assets/images/birmingham-crown-court.jpg" alt="" />
          ...
          <div id="location-codes">
              ...
              <p className="govuk-body-m">
                Crown Court location code: <span className="govuk-body-m">404</span>
              </p>
              <p className="govuk-body-m dx-number">
                DX: <span className="govuk-body-m">702033 Birmingham 8</span>
              </p>
          </div>
