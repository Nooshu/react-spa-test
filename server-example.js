// Example Express.js server for handling performance monitoring data
// This is just an example - you would integrate this into your actual backend
...
app.listen(port, () => {
  console.log(`🚀 Performance monitoring server running on http://localhost:${port}`)
